...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.ngOnInit = function () {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('[a-zA-z0-9]+( [a-zA-Z0-9]+)*')]),
            ...
            condition: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)
        });
...
var BodyComponent = /** @class */ (function () {
    ...
    BodyComponent.prototype.addToCart = function (event) {
        ...
        if (!localStorage.getItem('loggedIn')) {
            ...
            this.wishList.push(this.booksListing[bookId]);
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\" >\n  <a class=\"navbar-brand\" href=\"#\">World Of Books</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor02\" aria-controls=\"navbarColor02\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarColor02\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item active\">\n        <a class=\"nav-link\" routerLink='/'>Home <span class=\"sr-only\">(current)</span></a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/\">Features</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/\">Pricing</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"/\">About</a>\n      </li>\n    </ul>\n    <div class=\"btn-group\" role=\"group\" id='account' aria-label=\"Button group with nested dropdown\" style=\"margin-left: 10px\" >\n        <a routerLink=\"/wishList\" class=\"btn btn-secondary btn-sm p-append\" style=\"font-size: 14px;\"><i class=\"fab fa-opencart\"></i><span class=\"badge badge-primary badge-pill\">{{cartCount}}</span></a>\n        <a class=\"nav-link dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">My Account</a>\n        <div class=\"btn-group\" role=\"group\">\n          <div class=\"dropdown-menu\" aria-labelledby=\"btnGroupDrop2\" x-placement=\"bottom-start\" style=\"position: absolute; will-change: transform; top: 0px; left: -160px; transform: translate3d(0px, 38px, 0px);\">\n            <a class=\"dropdown-item\" routerLink='/signIn'>Login</a>\n            <a class=\"dropdown-item\" routerLink='/signUp'>Register</a>\n          </div>\n        </div>\n      </div>\n      <div id='loggedIn' class=\"btn-group\" role=\"group\" aria-label=\"Button group with nested dropdown\" style=\"margin-left: 10px\" >\n        <a routerLink=\"/wishList\" class=\"btn btn-secondary btn-sm p-append\" style=\"font-size: 14px;\"><i class=\"fab fa-opencart\"></i><span class=\"badge badge-primary badge-pill\">{{cartCount}}</span></a>\n        <a class=\"nav-link dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\" routerLink='/profile' style=\"color: white\">{{userName}}</a>\n        <div class=\"btn-group\" role=\"group\">\n          <div class=\"dropdown-menu\" aria-labelledby=\"btnGroupDrop2\" x-placement=\"bottom-start\" style=\"position: absolute; will-change: transform; top: 0px; left: -120px; transform: translate3d(0px, 38px, 0px);\">\n            <a class=\"dropdown-item\" routerLink='/logOut'>Logout</a>\n          </div>\n         <a routerLink=\"/message\" class=\"btn btn-secondary btn-sm p-append\" style=\"font-size: 14px;\"><i class=\"fas fa-envelope\"></i><span class=\"badge badge-primary badge-pill\">{{messageCount}}</span></a>\n        </div>\n      </div>\n  </div>\n</nav>\n\n"
